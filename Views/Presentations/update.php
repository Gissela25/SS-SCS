...
<head>
    ...
    <title>Actualizar presentación - Cruz Roja</title>
...
<body>
    <div class="row justify-content-center pt-5 mt-5 ">
        <div class="col-md-5">
            ...
            ?>
                    <form method="post" action="<?=PATH?>Presentations/SetPresentation" enctype="multipart/form-data" role="form">
                    <?php
                   if(isset($errores))
                   {
                       if(count($errores)>0)
                   ...
                   ?>
                    <input type="hidden" name="Id_Presentacion" id="Id_Presentacion" value="<?=$presentacion['Id_Presentacion']?>">
                        <div class="form-group text-center my-1">
                            <h3 class="text" style="color:#FF0032">Actualizar Presentación</h3>
                        </div>
                        <!-- <div class="">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Agregar Presentacion"
                                ...
                                value="<?=isset($presentacion)?$presentacion['NombreP']:''?>">
                        </div>

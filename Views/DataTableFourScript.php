        ...
        buttons: [
            'pageLength', {
                ...
                "customize": function(data) {
                    ...
                    return "IMPRESION DE INGRESOS POR RANGO DE FECHA\n" + espacios +
                        fechaLinea + "\n" + espacios2 +
                        "\n" + data;
                }
            }, {
                ...
                "title": "IMPRESION DE INGRESOS POR RANGO DE FECHA",
            }, {
                "extend": "pdfHtml5",
                ...
                "customize": function(doc) {
                    ...
                    doc.content.splice(0, 0, {
                        text: "IMPRESION DE INGRESOS POR RANGO DE FECHA",
                        fontSize: 10,
                        alignment: 'left',
                        margin: [0, 0, 0, 12]
                    });
                ...
                "customize": function(win) {
                    ...
                    $(win.document.body).find('h1').text(
                        "IMPRESION DE INGRESOS POR RANGO DE FECHA");

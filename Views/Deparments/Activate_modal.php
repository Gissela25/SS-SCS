<!-- Modal -->
<div class="modal fade" id="setModalStateOn_<?php echo $departamento['Id_Departamento']?>" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-4 my-2">
                <h4 class="text-center">¿Deseas realmente <span class="text-success">activar</span> a
                    <?=$departamento['NombreD']?>?</h4>
            </div>
            <div class="modal-footer">
                <form role="form" method="post" action="<?=PATH?>Deparments/Operations/<?=$departamento['Id_Departamento']?>">

...
<head>
    ...
    <title>Actualizar departamento - Cruz Roja</title>
...
<body>
    <div class="row justify-content-center pt-5 mt-5 ">
        <div class="col-md-5">
            ...
            ?>
                    <form method="post" action="<?=PATH?>Deparments/SetDeparment" enctype="multipart/form-data"
                        role="form">
                        <?php
                   if(isset($errores))
                   {
                   ...
                   ?>
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            ...
                            <a name="regresar" href="<?=PATH?>Deparments/Index" id="regresar"

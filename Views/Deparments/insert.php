...
<head>
    ...
    <title>Agregar departamento - Cruz Roja</title>
...
<body>
    <div class="row justify-content-center pt-5 mt-5 ">
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="<?=PATH?>Deparments/AddDeparment" enctype="multipart/form-data"
                        role="form">
                        <?php
                    if(isset($errores))
                    {
                    ...
                    ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Agregar Departamento" aria-label="Name"
                                ...
                                value="<?=isset($lugar)?$lugar['NombreD']:''?>">
                        </div>
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <button type="submit" class="btn btn-danger" name="Guardar" id="Guardar">Guardar</a>
                            </button>
                            <a name="regresar" href="<?=PATH?>Deparments/Index" id="regresar" class="btn btn-outline-danger"

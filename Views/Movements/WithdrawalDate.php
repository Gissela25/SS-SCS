...
<head>
    ...
    <title>Salidas por rango de fecha</title>
...
?>
    <div class="row mx-5 mt-5">
        <h2 style="text-align:center">Salidas por rango de fecha</h5>
                    ...
                    foreach($productos as $producto)
                    {
                        ...
                        ?>
                            <tr id="id_<?=$producto['Id_Correlativo']?>">
                                ...
                                <td class="text-center"><?=$producto['TotalSalida']?></td>
                                <td class="text-center"><a title="Movimientos"
                                        href="<?=PATH?>Movements/SeeSpecificWithdrawelByDate/<?=$producto['F_Movimiento']?>"
                                ...
                                <td class="text-center"><a title="MovimientosReport"
                                        href="<?=PATH?>Movements/WithdrawalByDateReport/<?=$producto['F_Movimiento']?>"
